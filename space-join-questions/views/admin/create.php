...
$this->title = Yii::t('SpaceJoinQuestionsModule.base', 'Create Question');
?>
...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        <?php $form = ActiveForm::begin([
            ...
            'action' => $space->createUrl('/space-join-questions/admin/create'),
        ]); ?>
            ...
            <div class="col-md-4">
                <?= $form->field($model, 'field_type')->dropDownList(
                    ...
                    [
                        ...
                        'prompt' => Yii::t('SpaceJoinQuestionsModule.base', 'Select field type...'),
                    ]
                ) ?>
            </div>
            <div class="col-md-4">
                ...
                ])->hint(Yii::t('SpaceJoinQuestionsModule.base', 'Lower numbers appear first. Leave empty for auto-assignment.')) ?>
            </div>
            <div class="col-md-4">
        ...
        <div class="row" id="field-options-row" style="display: none;">
            <div class="col-md-12">
